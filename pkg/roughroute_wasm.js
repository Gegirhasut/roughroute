/* @ts-self-types="./roughroute_wasm.d.ts" */
...
export class WasmRouter {
     ...
     */
    constructor(graph_bytes) {
        const ptr0 = passArray8ToWasm0(graph_bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmrouter_new(ptr0, len0);
        if (ret[2]) {
     ...
     */
    nodeCount() {
        const ret = wasm.wasmrouter_nodeCount(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     */
    route(req) {
        const ret = wasm.wasmrouter_route(this.__wbg_ptr, req);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./roughroute_wasm_bg.js": import0,
    };
}

const WasmRouterFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_wasmrouter_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('roughroute_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
